...
3. Choose AI Studio, Fixed Clips, or Subtitle Only. AI Studio shows creator modes/effects; Fixed Clips only asks for duration and adds only a PART label; Subtitle Only asks for duration and caption style.
